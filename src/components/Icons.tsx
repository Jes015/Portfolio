...
// icon:tailwind | Material Design Icons https://materialdesignicons.com/ | Austin Andrews

export const IconTailwind: TIcon = (props) => {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="currentColor"
...
export const IconGithub: TIcon = (props) => {
    return (
        <svg
...
// icon:git_commit | Devicons https://vorillaz.github.io/devicons/#/main | Theodore Vorillas
export const IconCommit: TIcon = (props) => {
    return (
        <svg
            viewBox="0 0 32 32"
            fill="currentColor"
        ...
        >
            <path
                fill="currentColor"
                d="M22.161 14.689c-.711-2.75-3.188-4.791-6.161-4.791s-5.449 2.041-6.161 4.791H4.821v3.194h5.018c.712 2.751 3.19 4.791 6.161 4.791s5.45-2.04 6.161-4.791h5.019v-3.194h-5.019zM16 19.48c-1.763 0-3.194-1.432-3.194-3.194s1.431-3.194 3.194-3.194c1.762 0 3.194 1.431 3.194 3.194S17.762 19.48 16 19.48z"
            />
        </svg>
    )
}

// icon:commitlint | Simple Icons https://simpleicons.org | SimpleIcons.org
export const IconCommitlint: TIcon = (props) => {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            ...
            {...props}
        >
            <path d="M7.988 4.822v.901h1.845v6.337c0 .809.187 1.433.563 1.875.379.438.913.657 1.6.657h1.458v-.97H12.11c-.37 0-.652-.13-.844-.393-.187-.263-.281-.652-.281-1.17V4.823zM3.459 7.418c-1.084 0-1.933.325-2.546.976C.304 9.044 0 9.944 0 11.096c0 1.15.304 2.051.913 2.702.613.65 1.462.976 2.546.976a3.67 3.67 0 001-.137c.33-.088.65-.221.958-.4V13.04c-.271.259-.565.45-.882.576a3 3 0 01-1.076.18c-.717 0-1.272-.232-1.664-.7-.387-.47-.582-1.138-.582-2.001 0-.868.195-1.535.582-2.002.388-.467.943-.7 1.664-.7.388 0 .734.06 1.038.181a3.1 3.1 0 01.92.588V7.956a4.255 4.255 0 00-.97-.406 3.74 3.74 0 00-.988-.132zm12.855 6.123v1.128H24V13.54zm3.156 2.255l-2.302 3.382h1.3l1.694-2.204 1.684 2.204h1.3l-2.301-3.382z" />
        </svg>
    )
}
